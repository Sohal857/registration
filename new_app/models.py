...
class UserProfileInfo(models.Model):
    ...
    email = models.EmailField(max_length=70, default = '', blank=True, null= True)
    website = models.URLField(max_length = 200, default = '', blank=True, null= True)
    company_name = models.CharField(max_length = 200, default = '', blank=True, null= True)
    ...
    street_address = models.CharField(max_length = 50,  default = '', blank=True, null= True)
